...
@test Dates.recur(x->Dates.DayOfWeek(x)==Dates.Mon,startdate,stopdate) == Januarymondays2014
@test Dates.recur(x->Dates.DayOfWeek(x)==Dates.Mon,startdate:stopdate) == Januarymondays2014
@test Dates.recur(x->Dates.DayOfWeek(x)!=Dates.Mon,startdate,stopdate;negate=true) == Januarymondays2014
